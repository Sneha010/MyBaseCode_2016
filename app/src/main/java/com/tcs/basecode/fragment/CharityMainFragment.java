 ...
 */
public class CharityMainFragment extends BaseFragment {

    public static CharityMainFragment newInstance() {
        CharityMainFragment fragment = new CharityMainFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_charity_main_layout, container, false);
    }
    ...
    public String getTitle() {
        return getResources().getString(R.string.h_charity);
    }
