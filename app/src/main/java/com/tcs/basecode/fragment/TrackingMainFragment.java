 ...
 */
public class TrackingMainFragment extends BaseFragment {

    public static TrackingMainFragment newInstance() {
        TrackingMainFragment fragment = new TrackingMainFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_tracking_main_layout, container, false);
    }
    ...
    public String getTitle() {
        return getResources().getString(R.string.h_tracking_and_results);
    }
